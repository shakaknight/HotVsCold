...
wd = webdriver.Chrome(r'D:\Selinium jars and drivers\drivers\chrome\chromedriver.exe',options=CO)

# Format for printing output
print ("Connecting to Worldwide weather data, Please wait .....\n")
weather_site = "https://www.timeanddate.com/weather/"
wd.get(weather_site)

wc = Select(wd.find_element_by_id("pop"))
wc.select_by_visible_text("Somewhat Popular (469)")
we = Select(wd.find_element_by_id("sort"))
we.select_by_visible_text("Temperature")
...
for i in range(1,len(table_row)):
    for j in lst:
        ...
        temp_val.append(t6) #list of list temeprature
